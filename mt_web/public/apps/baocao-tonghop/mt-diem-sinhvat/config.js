...
/*--- Setup Datatable ---*/
var table_dom = setup_datatable("#mt_diem_sinhvat_table_dom")
var url_indexid = api_admin_web + "mt-diem-sinhvat-indexid"
...
function onclick_read_details(url_indexid, obj) {
    $.ajax({
        ...
        success: function (data) {
            ...
            let data_fk_2 = data.data.list_mt_sinhvat

            $("#list_enterprise_tbody").html(list_fk(data_fk_1));
            $("#list_mt_sinhvat_tbody").html(list_fk(data_fk_2));
