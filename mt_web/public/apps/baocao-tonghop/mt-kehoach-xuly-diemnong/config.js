...
/*--- Setup Datatable ---*/
var table_dom = setup_datatable("#mt_kehoach_xuly_diemnong_table_dom")
var url_indexid = api_admin_web + "mt-kehoach-xuly-diemnong-indexid"
...
function onclick_read_details(url_indexid, obj) {
    $.ajax({
        ...
        success: function (data) {
            ...
            let data_fk_1 = data.data.list_mt_diemnong

            $("#list_mt_diemnong_tbody").html(list_fk(data_fk_1));
