...
select_1_option("#loaitulieu_id", "--Loại tư liệu--", api + "loaitulieu-option", "name")

/*--- Setup Datatable ---*/
var table_dom = setup_datatable("#mt_tulieu_moitruong_table_dom")
var url_indexid = api_admin_web + "mt-tulieu-moitruong-indexid"
