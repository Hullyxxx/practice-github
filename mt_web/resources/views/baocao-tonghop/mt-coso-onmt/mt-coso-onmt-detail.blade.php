            ...
            <div class="row mb-4 mt-4">
                ...
                <div class="col-lg-6 text-center">
                    <div class="card o-hidden mb-4">
                        <div class="card-header purple-500">
                            <div class="d-inline-block">
                                <span class="text-22 text-white">Quyết định xử lý</span>
                            </div>
                        </div>
                        <div class="card-title text-teal-600 mt-2 bg-white">
                            {{$key['name_soquyetdinh']}}
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 text-center">
                    <div class="card o-hidden mb-4">
                        <div class="card-header purple-500">
                            <div class="d-inline-block">
                                <span class="text-22 text-white">Loại ô nhiễm</span>
                            </div>
                        </div>
                        <div class="card-title text-teal-600 mt-2 bg-white">
                            {{$key['name_loaionhiem']}}
                ...
                <div class="col-lg-6 text-center">
                    <div class="card o-hidden mb-4">
                        <div class="card-header purple-500">
                            <div class="d-inline-block">
                                <span class="text-22 text-white">Mức độ ô nhiễm</span>
                            </div>
                        </div>
                        <div class="card-title text-teal-600 mt-2 bg-white">
                            {{$key['name_mucdo_onhiem']}}
                        </div>
                    </div>
                </div>
            </div>
        ...
        @foreach($result as $key)
            <div class="row my-xl-4">
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="text-18 text-purple line-height-1 mb-3">Nguyên nhân</h6>
                            <p class="mb-1">
                                {{$key['nguyennhan']}}
                            </p>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="text-18 text-purple line-height-1 mb-3">Thời gian xử lý</h6>
                            <p class="mb-1">
                                {{$key['thoigian_xuly']}}
                            </p>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="text-18 text-purple line-height-1 mb-3">Xử lý triệt để</h6>
                            <p class="mb-1">
                                {{$key['xuly_trietde']}}
                            </p>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <h6 class="text-18 text-purple line-height-1 mb-3">Xử lý tạm thời</h6>
                            <p class="mb-1">
                                {{$key['xuly_tamthoi']}}
                            </p>
                        </div>
