...
@section('tbody-td')
    @if (count($result) > 0)
        @foreach($result as $col)
            <tr>
                <td>
                    <a href='mt-diem-sinhvat-detail?id={{$col['id']}}' target='_blank'>
    ...
    <div class="col-md-12">
        ...
        <div id="foreign_key">
            <ul class="nav nav-tabs" id="listsTab" role="tablist">
                ...
                <li class="nav-item ">
                    <a class="nav-link " data-toggle="tab" href="#list_mt_sinhvat" role="tab" aria-controls="info_fk_2" aria-selected="false">
                        <i class="nav-icon i-Library mr-1"></i>
                        Sinh vật
                    </a>
                </li>
        ...
        <div id="related-lists" class="tab-content">
            ...
            <div class="tab-pane fade show " id="list_mt_sinhvat" role="tabpanel" aria-labelledby="main-info-tab">
                {{-- DOM data fk_2 --}}
                <table class="display table-middle-center table table-striped table-bordered" style="width:100%">
                    <tbody id="list_mt_sinhvat_tbody">
                    </tbody>
                </table>
            </div>
        </div>
...
@section('custom-js')
    <script src="{{'apps/baocao-tonghop/mt-diem-sinhvat/config.js'}}"></script>
@endsection
